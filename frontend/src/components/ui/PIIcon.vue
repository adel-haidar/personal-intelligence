...
// Stroke-based inline SVG icon set (consistent 24×24, 1.6 stroke).
// Mirrors PI_ICON_PATHS from pi-icons.jsx.
...
const PI_ICON_PATHS: Record<string, string> = {
  ...
  attach:      'M21.4 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.2-9.19a4 4 0 0 1 5.65 5.66l-9.2 9.19a2 2 0 0 1-2.82-2.83l8.49-8.48',
  ...
  thumbsUp:    'M7 10v12 M15 5.88L14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88z',
  thumbsDown:  'M17 14V2 M9 18.12L10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22a3.13 3.13 0 0 1-3-3.88z',
  ...
  watch:       'M12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10z M8.5 5.2L9 2h6l.5 3.2 M15.5 18.8L15 22H9l-.5-3.2',
  scale:       'M12 3a4 4 0 0 0-4 4h8a4 4 0 0 0-4-4z M5 7l-3 9a5 5 0 0 0 10 0L9 7 M19 7l-3 9a5 5 0 0 0 10 0l-3-9',
  device:      'M5 2h14a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z M12 18h.01',
  ...
  // additional aliases used in old nav
  email:       'M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6',
  bank:        'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
  job:         'M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z',
  hermes:      'M14.5 1.5L1.5 7l5 2 2 5z M14.5 1.5L6.5 9',
...
function getPaths(d: string): string[] {
  if (!d) return []
...
<template>
  ...
  >
    <path
      v-for="(d, i) in getPaths(PI_ICON_PATHS[name])"
      :key="i"
      :d="d"
    />
  </svg>
